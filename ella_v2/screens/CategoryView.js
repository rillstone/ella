...
class Overview extends Component {
    ...
    render() {
        ...
        const data = navigation.getParam('data', require('../assets/images/default_back.jpg'));
        ...
        return (
            ...
            <TouchableOpacity     onPress={() => {this.setState({scrollOp:0}); this.props.navigation.navigate('Home'); }}
                                            style={{
                                position: 'absolute',
                                right: 25,
                                top: 25,
